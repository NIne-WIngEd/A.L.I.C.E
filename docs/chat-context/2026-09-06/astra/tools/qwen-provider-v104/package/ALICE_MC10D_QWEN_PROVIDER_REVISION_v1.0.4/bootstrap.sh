...
name='ALICE_MC10D_QWEN_PROVIDER_REVISION_v1.0.4'
...
PY
exec "$PY" "$PACKAGE_ROOT/ALICE_MC10D_QWEN_PROVIDER_REVISION_v1.0.4/remote_agent.py" "$ACTION" --package-sha "$PACKAGE_SHA"
