...
> This is the frozen v100 source and original build record. Use the [active v101 Windows transport launcher](../qwen-transport-v101/README.md). The original workload bytes remain unchanged. [Failure analysis](../../QWEN_V100_WINDOWS_TRANSFER_FINDINGS.md) records why the client repair is needed.
