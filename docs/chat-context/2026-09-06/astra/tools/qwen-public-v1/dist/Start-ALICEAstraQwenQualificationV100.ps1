...
$Expected = "BC7C76C29A4F0FCFBD4567A610737EC5BB2052E7165677562959AC4DCA7C959E"
$ZipBase = "ALICE_MC10D_QWEN_PUBLIC_QUALIFICATION_v1.0.0"
$PackageName = $ZipBase
...
try {
    ...
    $RunRoot = Join-Path $OutputRoot "ALICE_QwenA1_RUN_$RunId"
...
'@
    ...
    Invoke-Python -Arguments @((Join-Path $PackageRoot "selftest_qwen.py"))
    ...
    Write-Host "ALICE_ASTRA_QWEN_V100_EXIT=$Code"
    ...
    Write-Host "ALICE_ASTRA_QWEN_V100_STOP: $($_.Exception.Message)" -ForegroundColor Yellow
