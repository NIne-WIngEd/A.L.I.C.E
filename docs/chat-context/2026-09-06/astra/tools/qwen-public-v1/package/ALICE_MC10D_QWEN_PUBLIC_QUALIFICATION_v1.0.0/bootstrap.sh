...
PACKAGE_ROOT="/homes/01/mxrayan/rayan-compute/packages/alice-qwen38-a1-8e7a384a745496f4/$PACKAGE_SHA"
...
name='ALICE_MC10D_QWEN_PUBLIC_QUALIFICATION_v1.0.0'
...
PY
exec "$PY" "$PACKAGE_ROOT/ALICE_MC10D_QWEN_PUBLIC_QUALIFICATION_v1.0.0/remote_agent.py" "$ACTION" --package-sha "$PACKAGE_SHA"
