...
PACKAGE=ROOT/'package/ALICE_MC10D_QWEN_RUNTIME_SUCCESSOR_v1.0.2'
OUTPUT=ROOT/'dist'
...
launcher=OUTPUT/'Start-ALICEAstraQwenQualificationV102.ps1'
text=(ROOT/'Start-ALICEAstraQwenQualificationV102.template.ps1').read_text(encoding='utf-8').replace('__ZIP_SHA256__',sha(archive).upper())
