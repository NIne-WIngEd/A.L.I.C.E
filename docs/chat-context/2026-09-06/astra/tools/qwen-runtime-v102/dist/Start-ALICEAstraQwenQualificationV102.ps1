...
$Expected = "F196F3B91604F5C35CA594DF001C10A6C1CEC87AA2962E544FADC3BA99FA9999"
$ZipBase = "ALICE_MC10D_QWEN_RUNTIME_SUCCESSOR_v1.0.2"
$PackageName = $ZipBase
...
try {
    ...
    if ([string]::IsNullOrWhiteSpace($ZipPath)) { throw "The exact v1.0.2 ZIP is missing beside this launcher, or its SHA-256 differs." }
...
'@
    ...
    Write-Host "Approved public Qwen calibration: Magnolia CPU, 20 CPUs, 48 GiB, six-hour job limit. Reruns attach to the same run."
    ...
    Write-Host "ALICE_ASTRA_QWEN_V102_EXIT=$Code"
    ...
    Write-Host "ALICE_ASTRA_QWEN_V102_STOP: $($_.Exception.Message)" -ForegroundColor Yellow
