...
name='ALICE_MC10D_QWEN_RUNTIME_SUCCESSOR_v1.0.2'
...
PY
exec "$PY" "$PACKAGE_ROOT/ALICE_MC10D_QWEN_RUNTIME_SUCCESSOR_v1.0.2/remote_agent.py" "$ACTION" --package-sha "$PACKAGE_SHA"
