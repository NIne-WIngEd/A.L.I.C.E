...
PACKAGE_ROOT="/homes/01/mxrayan/rayan-compute/packages/alice-qwen38-a3-750881d854fa/$PACKAGE_SHA"
...
name='ALICE_MC10D_QWEN_TELEMETRY_SUCCESSOR_v1.0.5'
...
PY
exec "$PY" "$PACKAGE_ROOT/ALICE_MC10D_QWEN_TELEMETRY_SUCCESSOR_v1.0.5/remote_agent.py" "$ACTION" --package-sha "$PACKAGE_SHA"
