...
## MC10D v2.0.0 current execution boundary

v1.9.4 exited 0. The pre-pointwise gate is complete. Exact private-pointwise input freeze SHA-256: `F232721A412D24304BE05DA100BFE27D6CA6B0124E7D1AC504AC14D85197EF01`.

The final runnable package is `ALICE_MC10D_PRIVATE_POINTWISE_SIMFALSIFY_v2.0.0.zip` SHA-256 `9DB60EE723F4804F2443AF0A4290D40CC14865D28DF4867634B76688AA1812AA`.

Launcher: `Start-ALICEMC10DPrivatePointwiseSimFalsifyV200.ps1` SHA-256 `1093E18BDC9486B8EB0026E435FB366049B8A9AF2F7C88C9B033396F6091472C`.

The earlier pre-release v2.0.0 hash `0B555ACD...A12D` is superseded and must not be used.

Read `MC10D_V194_SUCCESS_AND_V200_EXECUTION.md`.
