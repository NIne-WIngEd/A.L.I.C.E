...
N0's current identity-neutral full-envelope workflow remains separate. Job 576166 exited before GPU measurement because its evidence root already existed. Inspect that root's receipts and any writer before selecting a new versioned root; a preserved root is no GPU memory PASS and no training authorization.
