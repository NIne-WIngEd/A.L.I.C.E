...
These traces are procedures and partial outcomes. The [data and seed program](FBM_DATA_AND_SEED_PROGRAM_2026-09-26.md) requires separate cross-user input/target/outcome cases before calling them FBM training data.

The [received-data audit](FBM_EXISTING_DATA_AUDIT_2026-09-26.md) measures the existing 60-row N0 seed, two builder events, and 107 trace files. The [admission manifest](../../training/fbm/EXISTING_DATA_ADMISSION_2026-09-26.json) records their current builder train/eval exclusion; four [fictional case-shape fixtures](../../training/fbm/fixtures/fictional_case_shape_v0.1.jsonl) exercise subject, authority, correction, and sparse-assembly interfaces without claiming observed outcomes or training qualification. Two trace JSONL suffixes were repaired without changing their recorded objects. Continue the pinned N0 qualification without pulling the documentation-only N0 branch head into the Magnolia checkout.
