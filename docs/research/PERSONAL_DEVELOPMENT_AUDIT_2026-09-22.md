...
**Status:** accepted architecture finding; bounded representation repair implemented on this branch; learned development loop remains unimplemented  
**Branch:** `alice-personal-development-architecture-v1`  
**Base:** `alice-eipm-v1-n0-full-envelope-foundation-build-v1@6c4e3c02672b7a5415fb3407942d86cc9723b8d9`
...
The shared projection contract had one concrete host-neutrality defect: `self_model` could use the A.L.I.C.E.-specific subject type `alice_self`, but no product-neutral assistant-self subject type existed. This branch adds `assistant_self` while preserving `alice_self` for compatibility.
...
Astra's finding therefore does not justify discarding the current N0 direction. It does require the broader architecture to stop claiming that memory projections plus a fixed prompt already constitute personal development.
...
Implemented by this bounded correction:
