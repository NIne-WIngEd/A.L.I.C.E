...
SCHEMA = "alice.eipm.n0.dual-view-specialist-failure-localization.v0.2"
...
def main() -> None:
    ...
    for step in sorted(EXPECTED_CHECKPOINTS):
        ...
        print(f"checkpoint={step} phase=activation", flush=True)
        causal_prob = causal_specialist_probabilities(
            graph,
            adapter,
            causal_dev,
            device=device,
        ...
        checkpoint_results[str(step)] = {
            ...
            "causal_specialist_probability": qstats(causal_prob),
        ...
        print(
            ...
            + json.dumps(
                {
                    "step": step,
                    "causal_specialist_top1": qstats(causal_prob)["top1_at_0_5"],
    ...
    best_activation_step = max(
        ...
        key=lambda k: checkpoint_results[k][
            "causal_specialist_probability"
        ]["top1_at_0_5"],
    )

    audit = {
        "schema": SCHEMA,
        "status": "PASS_FAST_CAUSAL_DUAL_VIEW_SPECIALIST_FAILURE_LOCALIZATION_NO_GRADIENT",
        ...
        "summary": {
            ...
            ]["causal_specialist_probability"]["top1_at_0_5"],
