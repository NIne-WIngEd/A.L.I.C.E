...
from alice_personality.n0.qsre_production_core import QSREProductionBinder
...
from train_n0_v02_qsre_production_p3_v1 import (
    bind,
    execute,
    infer_operator,
    load_parents,
...
def main()->None:
    ...
    binder=QSREProductionBinder(config)
