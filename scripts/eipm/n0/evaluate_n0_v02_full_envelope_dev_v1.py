...
def main() -> None:
    ...
    result={
        ...
        "dev_evaluator_sha256":sha256_file(Path(__file__).resolve()),
        "dev_contract_sha256":sha256_file(args.dev_contract),
        "gate_registry_sha256":sha256_file(args.gate_registry),
        "proof_contract_sha256":sha256_file(args.proof_contract),
        "training_plan_sha256":sha256_file(contract["stage_gate_source"]),
