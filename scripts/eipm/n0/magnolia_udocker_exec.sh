...
for name in \
  ...
  ALICE_N0_REPO_ROOT \
  ALICE_N0_WORKDIR \
  ALICE_N0_CPU_RUNTIME_ROOT \
  ALICE_N0_EXPECTED_REVISION \
  ALICE_N0_ARB_CAL_DIR \
  ALICE_N0_ARB_DIR \
  ALICE_N0_FINAL_CHALLENGE_DIR \
  ALICE_N0_MISSING_EVIDENCE_DIAG_DIR \
  ALICE_N0_RELATION_SEMANTIC_DIR \
  ALICE_N0_RELATION_SEMANTIC_ROLE_RESIDUAL_DIR \
