...
BUILDER="$ROOT/scripts/eipm/n0/build_n0_v02_adaptive_multi_view_latent_pool_frozen_challenge_v0_1.py"
...
receipt={
  "schema":"alice.eipm.n0.v02-adaptive-multi-view-latent-pool-frozen-challenge-freeze.v0.1",
  ...
  "rows":160,"families":20,"thresholds_frozen_before_results":True,"challenge_rows_used_for_training":False,"training_authorized":False,
...
print("adaptive_latent_pool_confirmatory_v01_prepare_pass=true")
