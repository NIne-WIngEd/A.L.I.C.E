    ...
    torch.save(
        {
            ...
            "architecture": "open-schema-factorized-ordered-evidence-operator-v3",
            "stage": "P2",
            "step": step,
...
def main() -> None:
    ...
    with torch.no_grad():
        operator_model.query_norm.weight.copy_(
            schema_encoder.schema_norm.weight
        )
        operator_model.query_norm.bias.copy_(
            schema_encoder.schema_norm.bias
        )
    ...
    result = {
        ...
        "ordered_query_evidence_consumption": True,
        "failure_localization_job": 575957,
        "failure_localization_result_sha256": "da87d9436a7d4a928e45ea65582ab432c9d43254e2d1cbbaa8235ad28627e55b",
